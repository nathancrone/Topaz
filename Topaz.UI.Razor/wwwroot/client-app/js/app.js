(function (e) {
  function n(n) {
    for (
      var t, u, c = n[0], s = n[1], a = n[2], l = 0, h = [];
      l < c.length;
      l++
    )
      (u = c[l]),
        Object.prototype.hasOwnProperty.call(i, u) && i[u] && h.push(i[u][0]),
        (i[u] = 0);
    for (t in s) Object.prototype.hasOwnProperty.call(s, t) && (e[t] = s[t]);
    p && p(n);
    while (h.length) h.shift()();
    return o.push.apply(o, a || []), r();
  }
  function r() {
    for (var e, n = 0; n < o.length; n++) {
      for (var r = o[n], t = !0, u = 1; u < r.length; u++) {
        var s = r[u];
        0 !== i[s] && (t = !1);
      }
      t && (o.splice(n--, 1), (e = c((c.s = r[0]))));
    }
    return e;
  }
  var t = {},
  ...
  function u(e) {
    return (
      c.p +
      "js/" +
      ({ "chunk-admin": "chunk-admin", "chunk-publisher": "chunk-publisher" }[
        e
      ] || e) +
      ".js"
    );
  ...
  "56d7": function (e, n, r) {
    ...
    var t = r("2b0e"),
      ...
      u = (r("6294"), r("2877")),
      c = {},
      s = Object(u["a"])(c, i, o, !1, null, null, null),
      a = s.exports,
      l = (r("d3b7"), r("8c4f"));
    t["a"].use(l["a"]);
    var p = function (e) {
        return { id: parseInt(e.params.id) };
      },
      h = [
        {
          ...
          component: function () {
            return r.e("chunk-publisher").then(r.bind(null, "17d0"));
          },
        },
        {
          ...
          component: function () {
            return r.e("chunk-publisher").then(r.bind(null, "2609"));
          },
        },
        {
          ...
          component: function () {
            return r.e("chunk-publisher").then(r.bind(null, "9ab6"));
          },
        },
        {
          ...
          component: function () {
            return r.e("chunk-publisher").then(r.bind(null, "aed0"));
          },
        },
        {
          ...
          props: p,
          component: function () {
            return r.e("chunk-publisher").then(r.bind(null, "c625"));
          },
        },
        {
          ...
          component: function () {
            return r.e("chunk-publisher").then(r.bind(null, "6e9a"));
          },
        },
        {
          ...
          component: function () {
            return r.e("chunk-admin").then(r.bind(null, "1245"));
          },
        },
      ],
      f = new l["a"]({ mode: "history", base: "/client-app/", routes: h }),
      b = f;
